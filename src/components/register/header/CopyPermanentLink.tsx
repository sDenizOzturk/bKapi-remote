...
interface CopyPermanentLinkProps extends HTMLMotionProps<"div"> {
  doorNumber: String;
  token: String;
}

const CopyPermanentLink: FC<CopyPermanentLinkProps> = ({
  doorNumber,
  token,
}) => {
